...
from website.views import search_products,products,detail,search_package  # Import the view function
...
urlpatterns = [
    ...
    # path("packages/", packages, name='packages'),  # Added a distinct path for packages
